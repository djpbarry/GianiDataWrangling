...
CONF_LEVEL <- 0.95;
directory <- "Z:/working/barryd/GIANI_Paper/Sim_Data/sim_images_ground_truth";
INDEX = "Index";
NUCLEUS <- "Nucleus";
CYTOPLASM <- "Cytoplasm";
CELL <- "Cell";
...
MEAN <- "Mean";
IM_FOLDER_1 <- "Image Simulator_Output";
IM_FOLDER_2 <- "SimCellSeg_Statistics";
IM_NUC_POS_FILE_1 <- "Image Simulator_Output";
IM_CELL_VOL_FILE_1 <- "Image Simulator_Output";
IM_NUC_POS_FILE_2 <- "SimCellSeg_Nucleus_Position.csv";
IM_CELL_VOL_FILE_2 <- "SimCellSeg_Cell_Volume.csv";
...
#IM_CENTROID_X <- "Nucleus.Position.X";
#IM_CENTROID_Y <- "Nucleus.Position.Y";
#IM_CENTROID_Z <- "Nucleus.Position.Z";
