...
pdf(paste("plots", "imaris_volume_error_versus_snr.pdf", sep=.Platform$file.sep));
...
pdf(paste("plots", "imaris_norm_volume_error_versus_snr.pdf", sep=.Platform$file.sep));
...
pdf(paste("plots", "imaris_volume_error_versus_cell_number.pdf", sep=.Platform$file.sep));
...
pdf(paste("plots", "imaris_norm_volume_error_versus_cell_number.pdf", sep=.Platform$file.sep));
...
pdf(paste("plots", "imaris_norm_volume_error_versus_z.pdf", sep=.Platform$file.sep));
...
pdf(paste("plots", "imaris_proportionate_volume_error_versus_snr.pdf", sep=.Platform$file.sep), pointsize=20);
boxplot(Proportionate_Volume_Error~snr, data=allData, main="", xlab="SNR", ylab="Proportionate Volume Error", notch=TRUE, col=c("blue"));

dev.off();

pdf(paste("plots", "imaris_proportionate_volume_error_versus_cell_number.pdf", sep=.Platform$file.sep), pointsize=20);
